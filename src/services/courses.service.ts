...
export interface EnrollWithTeacherPayload { preferredTeacherId: string; subjects: Array<'mathematics' | 'programming'> }
export interface EnrollWithTeacherResult { enrolledCourses: string[]; teacherName: string; subjects: string[] }
export const coursesService = {
  ...
  enrollWithTeacher: async (payload: EnrollWithTeacherPayload) => { const { data } = await api.post<ApiResponse<EnrollWithTeacherResult>>('/courses/enroll-with-teacher', payload); return data.data },
}
