...
const prompts = ['Help me choose a subject', 'How do live classes work?', 'What should my child learn first?', 'Explain fractions simply', 'How does NumeryCode work?']
