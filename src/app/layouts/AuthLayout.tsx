  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex flex-col justify-between w-[45%] bg-brand-navy px-12 py-10">
        <Link to="/" className="flex items-center gap-2 text-white font-bold text-xl"><GraduationCap className="w-7 h-7 text-brand-sky" />NumeryCode</Link>
        <div>
        ...
        <p className="text-blue-400 text-sm">© 2026 NumeryCode</p>
      </div>
